...
alias g="git"
alias ll="ls -alhG"
alias cwatch="compass watch -c nimbus-local/config/compass-debug.rb httpdocs/assets/css"
alias ccomp="compass compile --force -c nimbus-local/config/compass-prod.rb httpdocs/assets/css"
alias ncwatch="compass watch -c nimbus-local/config/compass-debug.rb"
alias nccomp="compass compile --force -c nimbus-local/config/compass-prod.rb"
